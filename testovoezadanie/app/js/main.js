...
const swiperProd = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"]('.product__swiper', {
  // Optional parameters
  direction: 'horizontal',
  slidesPerView: 'auto',
  loop: true,
...
const swiperProdImg = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"](".mySwiper", {
  loop: true,
  spaceBetween: 10,
  slidesPerView: 4,
  freeMode: true,
...
const swiperProdImg2 = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"](".mySwiper2", {
  loop: true,
  spaceBetween: 10,
  navigation: {
    nextEl: ".swiper-button-next",
